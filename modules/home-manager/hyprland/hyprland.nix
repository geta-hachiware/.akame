    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod, Return, exec, kitty" # terminal
	      "$mainMod, Space, exec, ~/.akame/modules/home-manager/rofi/launcher/launcher.sh" # app launcher
        "$mainMod, T, exec, thunar" # file manager
        "$mainMod+Shift, C, exec, ~/.akame/modules/home-manager/rofi/clipboard/clipManager.sh" #clipboard
        "$mainMod, W, exec, ~/.akame/modules/home-manager/rofi/WallpaperSelect/wallpaper.sh" # wallpaper picker
        "$mainMod+Shift, N, exec, swaync-client -t -sw" # swayNC panel

        # Screenshot/Screencapture
        "$mainMod+Shift, J, exec, screenshot.sh --now"
        "$mainMod+Shift, K, exec, screenshot.sh --area"
        "$mainMod+Shift, L, exec, screenshot.sh --in5" # screenshot in 5 sec
